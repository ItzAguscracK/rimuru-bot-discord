...
module.exports = async (client, guild) => {
    try{
        ...
        console.log("Un servidor fue agregado a la base de datos.");
    } catch(err) {
        console.log(err);
    }
}
